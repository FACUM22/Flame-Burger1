...
async function subirImagen(file) {
    ...
    // Determinamos la extensión a partir del tipo MIME real,
    // no del nombre original (que puede traer espacios, acentos,
    // paréntesis, etc. y hacer fallar la subida a Supabase).
    ...
    const extension =
        extensionesPorTipo[file.mimetype] || ".jpg";
